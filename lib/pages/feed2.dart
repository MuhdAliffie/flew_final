...
class Feed2Page extends StatelessWidget {
  const Feed2Page({super.key});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: const Feed2PageState(),
      theme: ThemeData(
...
class Feed2PageState extends StatelessWidget {
  const Feed2PageState({super.key});
...
class InteractionButton extends StatelessWidget {
  ...
  InteractionButton({required this.icon, required this.count});
