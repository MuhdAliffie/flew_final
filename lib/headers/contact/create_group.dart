import 'package:flew_final/headers/contact/avatar_card.dart';
...
class CreateGroupState extends State<CreateGroup> {
  ...
  List<ChatModel> contacts = [
    ChatModel(name: "Kimbo", status: "A full stack developer"),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
            backgroundColor: const Color.fromARGB(255, 26, 23, 198),
            onPressed: () {},
            child: const Icon(
              Icons.arrow_forward,
